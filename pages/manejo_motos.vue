      ...
      <b-card class="bcard ">
        ...
        <b-form action="javascript:void(0)" @submit="crear_moto">
          ...
          <b-form-group label="Número soat" label-for="nro_soat" >
           ...
           <b-form-group label="Fecha vencimiento soat" label-for="vencimiento_soat">
            <b-form-datepicker
              class="form-control"
              v-bind:required="true"
           ...
           <b-form-group label="Fecha vencimiento tecnomecanica" label-for="vencimiento_tecnomecanica" >
             <b-form-datepicker
